...
/**
 * ライセンス詳細画面で発生する一回性の副作用。
 *
 * LicenseDetailUiEffect は、State として保持しない
 ...
 */
sealed interface LicenseDetailUiEffect : UiEffect {

    /**
     * 前画面へ戻る副作用。
     */
    data object NavigateBack : LicenseDetailUiEffect
